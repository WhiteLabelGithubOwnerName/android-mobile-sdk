...
- `StagingWalleeSdk.instance?.setLightTheme(JSONObject)` allows to modify the payment dialog's light theme.
- `StagingWalleeSdk.instance?.setDarkTheme(JSONObject)` allows to modify the payment dialog's dark theme.
- `StagingWalleeSdk.instance?.setCustomTheme(JSONObject, ThemeEnum)` allows to enforce a specific theme (dark, light or your own).
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        StagingWalleeSdk.instance?.setDarkTheme(getCustomTheme())
        StagingWalleeSdk.instance?.setLightTheme(getCustomTheme())
    }
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        StagingWalleeSdk.instance?.setCustomTheme(getCustomTheme(), ThemeEnum.DARK)
    }
...
```kotlin
  //...
StagingWalleeSdk.instance?.setCustomTheme(null, ThemeEnum.DARK)
```
